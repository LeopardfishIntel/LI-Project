...
const UpdateCostOfLivingOutputSchema = z.object({
    ...
    monthlyRent2BR: z.coerce.number().describe("Estimated average monthly rent for a 2-bedroom apartment in the city center in USD."),
    monthlyRent3BR: z.coerce.number().describe("Estimated average monthly rent for a 3-bedroom apartment in the city center in USD."),
...
- Monthly Rent (2-bedroom apartment, city center)
