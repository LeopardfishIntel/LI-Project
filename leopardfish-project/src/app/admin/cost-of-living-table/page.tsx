            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead>Rent (2BR)</TableHead>
                        <TableHead>Rent (3BR)</TableHead>
                ...
                <TableBody>
                    {locations.map(location => (
                        <TableRow key={location.id}>
                            ...
                            <TableCell>{formatCurrency(location.monthlyRent1BR ?? 0, location.currencyCode)}</TableCell>
                            <TableCell>{formatCurrency(location.monthlyRent2BR ?? 0, location.currencyCode)}</TableCell>
                            <TableCell>{formatCurrency(location.monthlyRent3BR ?? 0, location.currencyCode)}</TableCell>
                            <TableCell>{formatCurrency(location.averageMealCost ?? 0, location.currencyCode)}</TableCell>
                            <TableCell>{formatCurrency(location.transportPassCost ?? 0, location.currencyCode)}</TableCell>
