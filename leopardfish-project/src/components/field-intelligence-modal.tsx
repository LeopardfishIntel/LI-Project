            ...
            <DialogHeader>
              ...
              <DialogDescription asChild>
                <div className="bg-primary/10 border border-primary/20 p-4 rounded-sm text-[11px] text-primary-foreground/90 font-medium leading-relaxed text-left space-y-4">
                  <div>
                    <strong className="block mb-1 text-white tracking-widest text-[10px] font-bold normal-case">Security & Anonymity Notice</strong>
                  ...
                  <div>
                    <strong className="block mb-1 text-white tracking-widest text-[10px] font-bold normal-case">Operational Protocols</strong>
