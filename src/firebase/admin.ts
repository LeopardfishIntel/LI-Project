    ...
    for (const rawJob of jobs) {
      ...
      writeBatch.set(
        ref,
        {
          ...
          housingProvision: existing?.housingProvision || (extractedBenefits.housingProvision !== 'Unknown' ? extractedBenefits.housingProvision : null),
          tuitionWaiver: existing?.tuitionWaiver || (extractedBenefits.tuitionWaiver.provided ? extractedBenefits.tuitionWaiver : null),
          flightAllowance: existing?.flightAllowance || (extractedBenefits.flightAllowance !== 'Unknown' ? extractedBenefits.flightAllowance : null),
          taxFreePerk: existing?.taxFreePerk !== undefined ? existing.taxFreePerk : (extractedBenefits.taxFreePerk ? true : false),
          historicalMetadata,
          isHistorical,
