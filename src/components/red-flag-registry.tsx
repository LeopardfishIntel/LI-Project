...
export function RedFlagRegistry() {
  const flags = [
    ...
    {
      icon: <HeartPulse className="size-4 text-[#f97316]" />,
    ...
    <section className="py-24 bg-black/40 border-t border-white/5">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <Card className="glass rounded-sm overflow-hidden border-[#f97316]/20 shadow-2xl">
            <CardContent className="p-8 md:p-12 space-y-10">
              ...
              <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <Link href="/prepare" className="group flex items-center gap-3 bg-[#f97316]/10 hover:bg-[#f97316]/20 border border-[#f97316]/30 px-8 py-4 rounded-sm transition-all shadow-lg shadow-[#f97316]/5">
                  <span className="text-xs font-black uppercase tracking-[0.2em] text-[#f97316]">Access full flag registry</span>
                  <ArrowRight className="size-4 text-[#f97316] group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </CardContent>
          </Card>
