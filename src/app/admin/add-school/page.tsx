          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card className="glass border-white/5">
              ...
              <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <FormField control={form.control} name="costOfLiving.mobile" render={({ field }) => (<FormItem><FormLabel>Mobile</Label><FormControl><Input type="number" {...field} className="bg-background/50 border-white/10" /></FormControl><FormMessage /></FormItem>)} />
