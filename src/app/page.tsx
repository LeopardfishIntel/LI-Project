...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full h-[80vh] flex items-center overflow-hidden bg-background">
        <Image
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass p-8 space-y-6 flex flex-col justify-between group transition-all hover:border-primary/50 rounded-sm">
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div className="p-3 bg-primary/10 rounded-sm"><Target className="w-8 h-8 text-primary" /></div>
              ...
              <Link href="/discover" className="inline-flex items-center text-primary group-hover:translate-x-2 transition-transform self-start font-bold text-[10px] uppercase tracking-widest">
                Find Your Nook <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="glass p-8 space-y-6 flex flex-col justify-between group transition-all hover:border-primary/50 rounded-sm">
              ...
              <Link href="/financial-forecaster" className="inline-flex items-center text-primary group-hover:translate-x-2 transition-transform self-start font-bold text-[10px] uppercase tracking-widest">
                Decode Offer <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="glass p-8 space-y-6 flex flex-col justify-between group transition-all hover:border-primary/50 rounded-sm">
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div className="p-3 bg-primary/10 rounded-sm"><GitCompare className="w-8 h-8 text-primary" /></div>
              ...
              <Link href="/compare" className="inline-flex items-center text-primary group-hover:translate-x-2 transition-transform self-start font-bold text-[10px] uppercase tracking-widest">
                Final Verdict <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
            </div>
          </div>
        </div>
