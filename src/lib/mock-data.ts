...
export const schools: School[] = [
  ...
  },
  {
    ...
    intel: {
      salary: { value: '62,500 – 95,000 CZK (Gross)', score: 'good', isTaxFree: false },
      housing: { value: 'Relocation support only', provided: false },
      savingsPotential: { value: 'High', score: 'good' },
      curriculum: 'IGCSE, IB Diploma',
      studentTeacherRatio: '9:1',
      classSize: 14,
      healthInsurance: 'Full Czech Public Insurance',
      accreditation: 'HMC, IBO',
      jobsPortal: 'School Website, TES',
      minQualifications: 'Relevant Degree + PGCE/QTS',
      visaRestrictions: 'School-sponsored Employee Card for non-EU',
      benefitsSummary: 'Flight allowance, relocation support, public health insurance.',
      nonContactTime: 22,
      technologyEcosystem: 'Google Workspace, BYOD'
    },
    costOfLiving: { monthlyRent1BR: 925, monthlyRent2BR: 1250, monthlyRent3BR: 1850, food: 375, transport: 50, utilities: 235, internet: 30, mobile: 25, diningSocial: 300, vehicleInsuranceMaint: 0, uncoveredMedical: 50 },
  }
];
