 ...
 *
 * - findYourSweetSpot - A function that handles the teacher profile matching process.
 * - FindYourSweetSpotInput - The input type for the findYourSweetSpot function.
 * - FindYourSweetSpotOutput - The return type for the findYourSweetSpot function.
 */

import { ai } from '@/ai/genkit';
import { z } from 'zod';

const FindYourSweetSpotInputSchema = z.object({
...
export type FindYourSweetSpotInput = z.infer<typeof FindYourSweetSpotInputSchema>;

const FindYourSweetSpotOutputSchema = z.object({
...
export type FindYourSweetSpotOutput = z.infer<typeof FindYourSweetSpotOutputSchema>;

export async function findYourSweetSpot(
  input: FindYourSweetSpotInput
): Promise<FindYourSweetSpotOutput> {
  return findYourSweetSpotFlow(input);
}

const findYourSweetSpotPrompt = ai.definePrompt({
  name: 'findYourSweetSpotPrompt',
  input: { schema: FindYourSweetSpotInputSchema },
  output: { schema: FindYourSweetSpotOutputSchema },
...
const findYourSweetSpotFlow = ai.defineFlow(
  {
    name: 'findYourSweetSpotFlow',
    inputSchema: FindYourSweetSpotInputSchema,
    outputSchema: FindYourSweetSpotOutputSchema,
  },
  async (input) => {
    const { output } = await findYourSweetSpotPrompt(input);
    return output!;
  }
);
