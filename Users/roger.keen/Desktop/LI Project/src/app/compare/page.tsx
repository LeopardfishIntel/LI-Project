...
export default function ComparePage() {
    ...
    const { data: teacherProfile, isLoading: isLoadingProfile } = useDoc<TeacherProfile>(profileRef);
    ...
    useEffect(() => {
        if (schools && schools.length > 0 && selectedSchoolIds.length === 0 && teacherProfile) {
    ...
    }, [schools, selectedSchoolIds.length, teacherProfile]);
    ...
    if (isLoadingSchools || isUserLoading || isLoadingProfile || !schools) {
        return (
    ...
    if(!user || !teacherProfile) {
        return (
          <div className="container mx-auto flex flex-col justify-center items-center h-screen text-center">
            <p className="text-xl mb-4">Please log in and complete your profile to use the comparison tool.</p>
            <Button asChild>
    ...
    return (
        <div className="container mx-auto px-4 md:px-6 py-12">
            ...
            <div className="mt-16 flex justify-center">
                 <LeopardfishComparisonInsights schools={selectedSchools} teacherProfile={teacherProfile} />
            </div>
        </div>
    );
}
