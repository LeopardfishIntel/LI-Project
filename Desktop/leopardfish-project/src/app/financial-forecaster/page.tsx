    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-4 space-y-6">
          <Card className="glass border-primary/20 bg-background/40">
            <CardHeader><CardTitle className="text-sm font-black stamped-dossier text-primary/70">Operational settings</CardTitle></CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Select school dossier</Label>
              ...
              <div className="space-y-2">
                <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Family scaling</Label>
              ...
              <div className="bg-destructive/10 border border-destructive/20 p-4 rounded-sm">
                <div className="text-xs text-primary-foreground/90 leading-relaxed font-medium">
                  <span className="font-bold text-destructive uppercase tracking-tighter flex items-center gap-1 mb-1.5 text-xs"><ShieldAlert className="size-3.5" /> Due diligence</span>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-end">
                  <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Net monthly salary offer</Label>
                  {suggestedMonthlyLocal > 0 && !offeredSalary && <span className="text-[11px] font-black text-accent uppercase tracking-tighter animate-pulse">Suggested benchmark</span>}
                </div>
              ...
              <div className="space-y-2">
                <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Responsibilities allowance (monthly)</Label>
              ...
              <div className="space-y-2">
                <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Partner monthly salary</Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-end">
                  <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Student loan repayment (monthly)</Label>
                  <div className="flex gap-2 text-[11px] font-black text-accent uppercase tracking-tighter">
                    <Dialog>
                      <DialogTrigger asChild><span className="hover:text-white cursor-pointer transition-colors">UK</span></DialogTrigger>
                      <DialogContent className="glass border-white/10"><DialogHeader><DialogTitle>UK Loan Registry</DialogTitle><DialogDescription className="text-sm">Accessing 2026/27 overseas repayment thresholds. Direct connection to SLC protocol.</DialogDescription></DialogHeader><div className="py-4 text-sm space-y-2 text-muted-foreground"><p>Repayment thresholds vary based on your country's Price Level Index (PLI).</p><Button className="w-full bg-primary/20 text-primary border border-primary/30" asChild><Link href="/calculators/student-loan" target="_blank">Open calculator portal</Link></Button></div></DialogContent>
                    </Dialog>
                    <Dialog>
                      <DialogTrigger asChild><span className="hover:text-white cursor-pointer transition-colors">US</span></DialogTrigger>
                      <DialogContent className="glass border-white/10"><DialogHeader><DialogTitle>US Dept of Education Protocol</DialogTitle><DialogDescription className="text-sm">Analyzing FEIE exclusions and SAVE/RAP discretionary algorithmic logic.</DialogDescription></DialogHeader><div className="py-4 text-sm space-y-2 text-muted-foreground"><p>For most US teachers abroad, the FEIE exclusion can reduce monthly payments to 0 USD if income is below 126,000 USD.</p></div></DialogContent>
                    </Dialog>
              ...
              <div className="space-y-2">
                <Label className="text-xs font-black uppercase text-muted-foreground tracking-widest">Contingency buffer (monthly)</Label>
                <div className="relative">
        ...
        <div className="lg:col-span-8 space-y-8">
          {!selectedSchool ? (
            <div className="h-[600px] flex flex-col items-center justify-center border-2 border-dashed border-white/5 rounded-sm text-muted-foreground bg-card/20">
              ...
              <p className="stamped-dossier text-base text-white/30 tracking-[0.2em]">Initialise school dossier to begin decoding</p>
            </div>
          ) : (
            <>
              <div className="grid md:grid-cols-2 gap-8">
                <Card className="glass border-white/5 bg-background/40">
                  <CardHeader className="pb-4"><CardTitle className="text-xs font-black stamped-dossier text-primary flex items-center gap-2"><Award className="size-4" /> Income & Benefits</CardTitle></CardHeader>
                ...
                <Card className="glass border-white/5 bg-background/40">
                  <CardHeader className="pb-4"><CardTitle className="text-xs font-black stamped-dossier text-primary flex items-center gap-2"><Users className="size-4" /> Estimated costs</CardTitle></CardHeader>
                  <CardContent className="space-y-1">
                    ...
                    <div className="flex justify-between items-center pt-6 mt-4 border-t border-white/10">
                      <span className="text-[11px] font-black uppercase tracking-[0.2em] text-white">Burn rate</span>
                      <span className="text-3xl font-black text-primary">{formatCurrency(decodedCosts?.totalCosts || 0, currency)}</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
                ...
                <div className="space-y-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="space-y-1 text-center md:text-left">
                            <h4 className="text-xs font-black text-muted-foreground uppercase tracking-[0.2em]">True net savings</h4>
                    ...
                    <div className="pt-8 border-t border-white/5 space-y-6">
                        <div className="flex items-center gap-3">
                            <h3 className="text-base stamped-dossier text-primary flex items-center gap-2">
                        ...
                        {verdict ? (
                            ...
                            <div className="py-12 flex flex-col items-center justify-center text-center space-y-3 opacity-30">
                                ...
                                <p className="text-xs font-black uppercase tracking-widest">Uplinking to tactical engine...</p>
                            </div>
                        )}
                    </div>
                </div>
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      <div className="mb-16 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto font-medium text-base leading-relaxed uppercase tracking-widest opacity-60">Field-grade financial intelligence for your next move.</p>
      </div>
