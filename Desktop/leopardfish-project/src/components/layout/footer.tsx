      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center md:text-left">
                <h4 className="text-xs font-black tracking-[0.2em] text-white mb-6">Quick links</h4>
                <nav className="flex flex-col gap-3">
                    ...
                    <Link href="/partners" className="text-base font-bold text-muted-foreground hover:text-primary transition-colors">Partners</Link>
                </nav>
            </div>

             <div className="text-center md:text-right">
                <h4 className="text-xs font-black tracking-[0.2em] text-white mb-6">Contact</h4>
